...
flight1 = Flight(flightNumber="A123", airline="AirFly", departureDateTime=datetime(2024, 5, 25, 15, 30), gate="A1")
flight2 = Flight(flightNumber="B456", airline="UpHigh", departureDateTime=datetime(2024, 5, 26, 10, 45), gate="B2")
...
boarding_pass3 = BoardingPass(bookingID="G001", passenger=group_passenger, seat="10A", flight=flight1)
boarding_pass4 = BoardingPass(bookingID="G001", passenger=group_passenger, seat="10B", flight=flight1)
boarding_pass5 = BoardingPass(bookingID="G001", passenger=group_passenger, seat="10C", flight=flight1)
...
data = {
    ...
    "boarding_passes": [boarding_pass1, boarding_pass2, boarding_pass3, boarding_pass4, boarding_pass5]
}